...
public class TabChat extends JPanel {
    ...
    private void addLabel() {
        JLabel label = new JLabel() {
            ...
            public String getText() {
                int index = cl.tabbedPane.indexOfTabComponent(TabChat.this);
                if (index != -1) {
                    return cl.tabbedPane.getTitleAt(index);
                }
                return null;
            }
        };
    ...
    class CustomButton extends JButton implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            int index = cl.tabbedPane.indexOfTabComponent(TabChat.this);
            cl.tabbedPane.setSelectedIndex(index);
            int i = cl.tabbedPane.getSelectedIndex();
            if (index != -1) {
                System.out.println(cl.tabbedPane.getTitleAt(i));
                cl.list.remove(cl.tabbedPane.getTitleAt(index));
                cl.removeTab(index);
            }
        }
